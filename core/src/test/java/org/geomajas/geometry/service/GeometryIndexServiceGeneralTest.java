...
public class GeometryIndexServiceGeneralTest {
	...
	@Test
	public void isShellTest() {
		Assert.assertTrue(service.isShell(service.create(GeometryIndexType.TYPE_GEOMETRY, 0)));
		Assert.assertFalse(service.isShell(service.create(GeometryIndexType.TYPE_GEOMETRY, 5)));
		Assert.assertTrue(service.isShell(service.create(GeometryIndexType.TYPE_GEOMETRY, 0, 0)));
		Assert.assertFalse(service.isShell(service.create(GeometryIndexType.TYPE_GEOMETRY, 5, 5)));
	}
